...
//Adding Background Images to DB
...
function showinfo(bool){
    if(bool){
       var i1 =  document.getElementsByClassName("info1")[0].style.display="inline";
        var i2 =  document.getElementsByClassName("info2")[0].style.display="inline";
        var i3 =  document.getElementsByClassName("info3")[0].style.display="inline";
        var i4 =  document.getElementsByClassName("info4")[0].style.display="inline";
        var i5 =  document.getElementsByClassName("info5")[0].style.display="inline";
        var i6 =  document.getElementsByClassName("info6")[0].style.display="inline";
    }
    else{
        var i1 =  document.getElementsByClassName("info1")[0].style.display="none";
        var i2 =  document.getElementsByClassName("info2")[0].style.display="none";
        var i3 =  document.getElementsByClassName("info3")[0].style.display="none";
        var i4 =  document.getElementsByClassName("info4")[0].style.display="none";
        var i5 =  document.getElementsByClassName("info5")[0].style.display="none";
        var i6 =  document.getElementsByClassName("info6")[0].style.display="none";
    }
}
...
function CreateServer(){
    ...
    request += "%20sans"
    request += "&color3=";
    if(text3.style.color != "") request += rgb2hex(text3.style.color);
    else request +="%23fff";
...
function Info(pos){
    ...
    document.getElementById("Nrselected").innerText =meme.Likes.length;
    document.getElementById("Nrgenerate").innerText =meme.Dislikes.length;
...
function ScreenshotUrl(){
    ...
    if(url.length >4){
        var request = "https://api.apiflash.com/v1/urltoimage?access_key=8a1d6e65696b4a0ab25283641e6a221e&url="+url;
...
function reposText(x,y,num){
    x*=100;
    y*=100;
    if(num==1)t1left = (x+7.1)*2
    if(num==2)t3left = (x+7.1)*2
